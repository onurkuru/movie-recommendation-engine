...
<head>
  ...
  <title>Sekizbuçuk Film Öneri Robotu</title>
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "https://api.themoviedb.org/3/movie/".$id."?append_to_response=videos%2Ccredits%2C&language=tr-TR&api_key=6f10bed37d2a9c745dfd3af6afcecc63",
...
<div class="title"><?=$title?></div>
  ...
  <div class="watchlist"><i class="ion-heart"></i>İZLEME LİSTESİNE EKLE</div>
...
if( check == ''){
    ...
    $this.html(function(i, v){
       return v === '<img src="img/like1.png" title="Heart" width="16" height="16"> İZLEME LİSTESİNE EKLE' ? '<img src="img/like2.png" title="Heart" width="16" height="16"> İZLEME LİSTESİNDE' : '<img src="img/like2.png" title="Heart" width="16" height="16"> İZLEME LİSTESİNDE'
    });
       }
    });
